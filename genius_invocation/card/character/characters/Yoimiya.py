...
class Yoimiya(Character):
    ...
    def balance_adjustment():
        log = {}
        log[3.4] = "调整了「七圣召唤」中角色牌「宵宫」的元素爆发所需充能数，元素骰子数量和造成的伤害：所需充能数由2调整为3，所需骰子数量由3个火元素骰子调整为4个，“造成3点火元素伤害……”调整为“造成4点火元素伤害……”"
        log[3.8] = "调整了「七圣召唤」中，角色牌「宵宫」元素爆发所需元素骰和伤害：元素爆发所需元素骰由4个火元素骰调整为3个火元素骰，造成4点火元素伤害调整为造成3点火元素伤害"
