...
Traceback (most recent call last):
  File "E:\GitHub\Genius-Invokation\test\test_character_solo\test_solo_Dehya.py", line 69, in test
    self.check_health(1, [89, 10, 10])
  File "E:\GitHub\Genius-Invokation\test\test_character_solo\test_solo_Dehya.py", line 110, in check_health
    self.assertEqual(self.game.players[player].character_list[i].health_point, health[i])
AssertionError: 92 != 89
'''
#TODO: Check prepared skill used properly in this test. 
class TestDehya(TestBase, unittest.TestCase):
