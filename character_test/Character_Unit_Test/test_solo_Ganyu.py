...
class TestGanyu(TestBase, unittest.TestCase):
    ...
    def test(self):
        ...
        self.run_actions_for_player(skill_action_list[1], 0)
        ...
        self.check_health(1, [95, 8, 8])
        self.check_elemental_application(1, [[ElementType.CRYO], [], []])
        self.assertEqual(self.game.players[0].dice_zone.num(), 5)
        self.game.players[0].dice_zone.add([7] * 3)

        self.run_actions_for_player(skill_action_list[3], 0)  # Q技能
        self.check_health(1, [93, 7, 7])
        self.check_elemental_application(1, [[ElementType.CRYO], [], []])
        self.assertEqual(self.game.players[0].dice_zone.num(), 5)
        self.game.players[0].dice_zone.add([7] * 3)

        self.run_actions_for_player(skill_action_list[0], 0)  # 平a
        self.check_health(1, [91, 7, 7])
        self.check_elemental_application(1, [[ElementType.CRYO], [], []])
        self.assertEqual(self.game.players[0].dice_zone.num(), 5)
        self.game.players[0].dice_zone.add([7] * 3)

        self.run_actions_for_player(skill_action_list[1], 0)  # 第一个E技能
        self.check_health(1, [90, 7, 7])
        self.check_elemental_application(1, [[ElementType.CRYO], [], []])
        self.assertEqual(self.game.players[0].dice_zone.num(), 5)
        self.game.players[0].dice_zone.add([7] * 3)

        self.run_actions_for_player(skill_action_list[2], 0)  # 第二个E技能，如果没有，则重复释放
        self.check_health(1, [88, 5, 5])
        self.check_elemental_application(1, [[ElementType.CRYO], [], []])
        self.assertEqual(self.game.players[0].dice_zone.num(), 5)
        self.game.players[0].dice_zone.add([7] * 3)

        self.run_actions_for_player(skill_action_list[3], 0)  # Q技能
        self.check_health(1, [86, 4, 4])
        self.check_elemental_application(1, [[ElementType.CRYO], [], []])
        self.assertEqual(self.game.players[0].dice_zone.num(), 5)
        self.game.players[0].dice_zone.add([7] * 3)
