...
Traceback (most recent call last):
  File "E:\GitHub\Genius-Invokation\test\test_character_solo\test_solo_Klee.py", line 56, in test
  ...
  File "E:\GitHub\Genius-Invokation\genius_invocation\card\character\characters\Klee.py", line 39, in on_call
...
AttributeError: 'ExplosiveSpark' object has no attribute 'usage'
'''

class TestKlee(TestBase, unittest.TestCase):
