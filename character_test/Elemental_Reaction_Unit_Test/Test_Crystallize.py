...
class TestBarbara(TestBase, unittest.TestCase):
    player0_deck: Dict[str, List[str]] = {
        'character': ['Klee', 'Ningguang', 'Nahida'],
    ...
    def test(self):
        ...
        self.assertEqual(self.game.players[0].character_list[1].health_point, 9)
        self.assertEqual(self.game.players[0].character_list[1].elemental_application, [])
