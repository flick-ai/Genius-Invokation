...
Traceback (most recent call last):
  File "E:\GitHub\Genius-Invokation\test\test_character_solo\test_solo_Ningguang.py", line 62, in test
  ...
  File "E:\GitHub\Genius-Invokation\genius_invocation\card\character\characters\Ningguang.py", line 115, in on_call
  ...
  File "E:\GitHub\Genius-Invokation\genius_invocation\event\events.py", line 23, in __call__
    self.action(game)
  File "E:\GitHub\Genius-Invokation\genius_invocation\card\character\characters\Ningguang.py", line 169, in on_damage_add
    game.current_damage += 2
TypeError: unsupported operand type(s) for +=: 'Damage' and 'int'
'''

class TestNingguang(TestBase, unittest.TestCase):
