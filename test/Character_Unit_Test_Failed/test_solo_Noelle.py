...
Traceback (most recent call last):
  File "E:\GitHub\Genius-Invokation\test\test_character_solo\test_solo_Noelle.py", line 62, in test
  ...
  File "E:\GitHub\Genius-Invokation\test\test_base.py", line 83, in run_actions_for_player
    game.step(action)
  File "E:\GitHub\Genius-Invokation\genius_invocation\game\game.py", line 223, in step
    self.active_player.generate_mask(self)
  File "E:\GitHub\Genius-Invokation\genius_invocation\game\player.py", line 295, in generate_mask
    has_dice = self.calculate_dice(game, Dice(from_player=self,
  File "E:\GitHub\Genius-Invokation\genius_invocation\game\player.py", line 331, in calculate_dice
  ...
  File "E:\GitHub\Genius-Invokation\genius_invocation\event\events.py", line 23, in __call__
    self.action(game)
  File "E:\GitHub\Genius-Invokation\genius_invocation\card\character\characters\Noelle.py", line 189, in on_calculation
    if game.current_dice[0]['cost_num']>0:
TypeError: 'Dice' object is not subscriptable
'''

class TestNoelle(TestBase, unittest.TestCase):
    ...
    def test(self):
        ...
        self.assertEqual(self.game.players[0].character_list[0].health_point, 10)
