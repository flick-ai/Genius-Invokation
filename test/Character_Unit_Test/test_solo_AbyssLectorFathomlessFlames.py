...
class TestAbyssLectorFathomlessFlames(TestBase, unittest.TestCase):
    ...
    def test(self):
        ...
        # 对方A
        self.run_actions_for_player(skill_action_list[0], 1)
        self.assertEqual(self.game.players[0].character_list[0].health_point, 2)
        self.assertEqual(self.game.players[0].character_list[0].elemental_application, [])

        # 回合1节末伤害检测
        self.check_health(1, [79, 9, 9])
        self.check_elemental_application(1, [[ElementType.PYRO], [], []])
